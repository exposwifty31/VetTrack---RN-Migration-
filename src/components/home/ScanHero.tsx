...
export function ScanHero({ onPress }: { onPress: () => void }) {
  ...
  return (
    <View className="px-[22px] pt-3">
      ...
      >
        <View
          className="flex-row items-center gap-3.5 rounded-[24px] bg-gradient-to-b from-[#8B5CF6] to-[#6D28D9] px-5 py-[18px]"
        ...
        >
          ...
          <View className="flex-1">
            ...
            <Text className="mt-[1px] font-rubik text-[12.5px] text-[rgba(255,255,255,0.85)]">
